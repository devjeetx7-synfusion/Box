...
import com.boxx.datasync.utils.DataUtils
    ...
    Scaffold(
        ...
        Column(
            ...
            InfoCard("Environment Information", listOf(
                "App Version" to com.boxx.datasync.BuildConfig.VERSION_NAME,
            ...
            Row(
                ...
                TextButton(onClick = { DataUtils.copyToClipboard(context, errorDetails) }) {
